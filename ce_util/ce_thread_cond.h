...
#ifndef CE_THREAD_COND_H
#define CE_THREAD_COND_H

/**
 * @file ce_thread_cond.h
 * @brief CE Condition Variable Routines
 */
...
/**
 * @defgroup ce_thread_cond Condition Variable Routines
 * @ingroup CE 
 * @{
 */
 ...
 */
extern  ce_int_t ce_thread_cond_create(ce_thread_cond_t **cond,
                                                 ce_pool_t *pool);
 ...
 * met.
 */
extern  ce_int_t ce_thread_cond_wait(ce_thread_cond_t *cond,
 ...
 *        will wake up before this time, otherwise the error CE_TIMEUP
 *        is returned.
 */
#if 0
extern  ce_int_t ce_thread_cond_timedwait(ce_thread_cond_t *cond,
                                                    ce_thread_mutex_t *mutex,
 ...
 */
extern  ce_int_t ce_thread_cond_signal(ce_thread_cond_t *cond);
 ...
 * @remark If no threads are waiting on the condition variable, nothing happens.
 */
extern  ce_int_t ce_thread_cond_broadcast(ce_thread_cond_t *cond);

/**
 * Destroy the condition variable and free the associated memory.
 * @param cond the condition variable to destroy.
 */
extern  ce_int_t ce_thread_cond_destroy(ce_thread_cond_t *cond);
