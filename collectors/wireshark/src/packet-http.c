...
static int proto_http = -1;
 int hf_http_notification = -1;
 int hf_http_response = -1;
 int hf_http_request = -1;
 int hf_http_basic = -1;
 int hf_http_request_method = -1;
 int hf_http_request_uri = -1;
 int hf_http_request_full_uri = -1;
 int hf_http_version = -1;
 int hf_http_response_code = -1;
 int hf_http_response_phrase = -1;
 int hf_http_authorization = -1;
 int hf_http_proxy_authenticate = -1;
 int hf_http_proxy_authorization = -1;
 int hf_http_proxy_connect_host = -1;
 int hf_http_proxy_connect_port = -1;
 int hf_http_www_authenticate = -1;
 int hf_http_content_type = -1;
 int hf_http_content_length_header = -1;
 int hf_http_content_length = -1;
 int hf_http_content_encoding = -1;
 int hf_http_transfer_encoding = -1;
 int hf_http_upgrade = -1;
 int hf_http_user_agent = -1;
 int hf_http_host = -1;
 int hf_http_connection = -1;
 int hf_http_cookie = -1;
 int hf_http_accept = -1;
 int hf_http_referer = -1;
 int hf_http_accept_language = -1;
 int hf_http_accept_encoding = -1;
 int hf_http_date = -1;
 int hf_http_cache_control = -1;
 int hf_http_server = -1;
 int hf_http_location = -1;
 int hf_http_sec_websocket_accept = -1;
 int hf_http_sec_websocket_extensions = -1;
 int hf_http_sec_websocket_key = -1;
 int hf_http_sec_websocket_protocol = -1;
 int hf_http_sec_websocket_version = -1;
 int hf_http_set_cookie = -1;
 int hf_http_last_modified = -1;
 int hf_http_x_forwarded_for = -1;
 int hf_http_request_in = -1;
 int hf_http_response_in = -1;
 int hf_http_next_request_in = -1;
 int hf_http_next_response_in = -1;
 int hf_http_prev_request_in = -1;
 int hf_http_prev_response_in = -1;
 int hf_http_time = -1;
